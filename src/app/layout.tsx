...
export const metadata: Metadata = {
  metadataBase: new URL("https://ise.ie"),
  title: "Immersive Software Engineering",
  description: "Ireland's premier software engineering programme combining academic excellence with real-world industry experience.",
};
